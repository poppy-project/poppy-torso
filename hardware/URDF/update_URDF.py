...
def update_URDF_from_config(urdf_path, config_path):
	...
	j['limit'] = collections.OrderedDict() # added by sebastien because no 'limit' key on head_z at least
...
if __name__ == '__main__':
    ...
    urdf_path = './robots/Poppy_Torso.URDF'
    config_path = '../../../explaupoppydiva/robots/torso_config.json'
    config_path = '../../../poppy-humanoid/software/poppy_humanoid/configuration/poppy_humanoid.json'
